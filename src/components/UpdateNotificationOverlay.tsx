      ...
      >
        ...
        <div className="flex items-center gap-2.5">
          ...
          <button
            ...
            className="shrink-0 border border-border/70 bg-background text-foreground hover:bg-foreground/[0.04] active:bg-foreground/[0.06] text-[11px] font-medium px-2.5 py-1 rounded-md transition-colors"
          >
