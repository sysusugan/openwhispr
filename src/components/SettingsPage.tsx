...
export default function SettingsPage({
  ...
  }, [notificationsEnabled, notifyMeetingDetection, notifyUpdates]);
      ...
      case "general":
        return (
          <div className="space-y-6">
            ...
            <div>
              <SectionHeader
                title={t("meetingDetection.title")}
                description={t("meetingDetection.description")}
              />
              <SettingsPanel>
                <SettingsPanelRow>
                  <SettingsRow
                    label={t("meetingDetection.audioDetection")}
                    description={t("meetingDetection.audioDescription")}
                  >
                    <Toggle
