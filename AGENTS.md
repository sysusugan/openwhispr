...
- Supports multiple AI providers (all models defined in `src/models/modelRegistryData.json`):
  ...
  - **Anthropic** (Via IPC bridge to avoid CORS):
    - Codex Opus 4.7 (`Codex-opus-4-7`) - Most capable Codex model, 1M context
    ...
    - Codex Opus 4.6 (`Codex-opus-4-6`) - Previous Opus generation, 1M context
    - Codex Sonnet 4.5 (`Codex-sonnet-4-5`) - Previous Sonnet generation
    - Codex Opus 4.5 (`Codex-opus-4-5`) - Earlier Opus model
